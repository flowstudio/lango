...
var lango = /*@__PURE__*/(function () {
	...
	var prototypeAccessors = { localeData: { configurable: true } };

	prototypeAccessors.localeData.get = function () {
	...
	Object.defineProperties( Lango.prototype, prototypeAccessors );

	return Lango;
}());

module.exports = lango;
